...
[Abstract](#){: .toggle-link data-target="paper3" } | [PDF](https://www.dropbox.com/scl/fi/9xlkw3g3hoqd8neqtr3qy/mainpaper.pdf?rlkey=x2di4sfm5kg5593&st=xnsar1ci&dl=0) 
...
[Abstract](#){: .toggle-link data-target="paper4" } | [PDF](/papers/Corti_dei_conti.pdf)
...
This project investigates how political connections shape discretionary land-use decisions. We study the City of Los Angeles’s discretionary entitlement process, where both elected officials and planning staff exert substantial influence over the approval of land-use development projects. We assemble a new dataset covering every entitlement application filed between 2010 and 2023, linking each case to environmental reviews, staff assignments, appeals, and City Council deliberations, thereby capturing the full trajectory of each project from initial filing to final approval. We complement these administrative records with more than 30,000 planning determination letters, from which we extract information on property owners, representatives, and decision makers using large language models. This work aims to quantify whether politically connected developers receive faster, more favorable, or less scrutinized approvals within LA’s complex entitlement system, shedding light on the economic value of political and bureaucratic connections in urban development.
</div>
